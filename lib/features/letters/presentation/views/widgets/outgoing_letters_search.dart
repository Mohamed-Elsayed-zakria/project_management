...
class OutgoingLettersSearch extends StatefulWidget {
  const OutgoingLettersSearch({super.key});

  @override
  State<OutgoingLettersSearch> createState() => _OutgoingLettersSearchState();
}

class _OutgoingLettersSearchState extends State<OutgoingLettersSearch> {
  late OutgoingLetterCubit cubit;

  @override
  void initState() {
    super.initState();
    cubit = BlocProvider.of<OutgoingLetterCubit>(context);
