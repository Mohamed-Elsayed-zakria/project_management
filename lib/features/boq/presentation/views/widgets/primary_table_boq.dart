...
import 'add_boq_data_dialog.dart';

class PrimaryTableBoq extends StatelessWidget {
  final BoqData boqData;
  const PrimaryTableBoq({
    super.key,
          ...
          children: [
            InkWell(
              onTap: () {
                showDialog(
                  context: context,
                  builder: (context) => AddBoqDataDialog(
                    onPressed: () {
  ...
  List<TableRow> buildTableRowBoqNewElements() {
